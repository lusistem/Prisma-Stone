...
<div style="background-color: #1a252f; padding: 12px; border-radius: 8px; text-align: center; margin-bottom: 20px; position: sticky; top: 0; z-index: 1000;">
  ...
  <a href="#blog" style="color: white; background-color: #34495e; padding: 8px 14px; text-decoration: none; border-radius: 4px; font-weight: bold; margin: 3px; display: inline-block;">BLOG</a>
...
<a id="blog"></a>
## BLOG
Espacio reservado para novedades, recomendaciones o artículos relacionados con tu rubro.
